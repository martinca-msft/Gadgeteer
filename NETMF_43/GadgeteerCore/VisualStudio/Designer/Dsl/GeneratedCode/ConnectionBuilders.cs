...
namespace Microsoft.Gadgeteer.Designer
{
	...
	/// </summary>
	internal partial class SocketConnectionToolConnectAction : DslDiagrams::ConnectAction
	{
		private DslDiagrams::ConnectionType[] connectionTypes;
		
		/// <summary>
		/// Constructs a new SocketConnectionToolConnectAction for the given Diagram.
		/// </summary>
		public SocketConnectionToolConnectAction(DslDiagrams::Diagram diagram): base(diagram, true) 
		{
		}
		...
		/// <summary>
		/// Returns the SocketConnectionToolConnectionType associated with this action.
		/// </summary>
		protected override DslDiagrams::ConnectionType[] GetConnectionTypes(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement)
		{
			...
			{
				this.connectionTypes = new DslDiagrams::ConnectionType[] { new SocketConnectionToolConnectionType() };
			}
			
			return this.connectionTypes;
		}
		
		private partial class SocketConnectionToolConnectionTypeBase : DslDiagrams::ConnectionType
		{
			/// <summary>
			/// Constructs a new the SocketConnectionToolConnectionType with the given ConnectionBuilder.
			/// </summary>
			protected SocketConnectionToolConnectionTypeBase() : base() {}
		...
		private partial class SocketConnectionToolConnectionType : SocketConnectionToolConnectionTypeBase
		{
			/// <summary>
			/// Constructs a new the SocketConnectionToolConnectionType with the given ConnectionBuilder.
			/// </summary>
			public SocketConnectionToolConnectionType() : base() {}
		}
	}
}
