...
namespace Microsoft.Gadgeteer.Designer
{
	...
	/// </summary>
	internal partial class GadgeteerDSLDocView : GadgeteerDSLDocViewBase
	{
		/// <summary>
		/// Constructs a new GadgeteerDSLDocView.
		/// </summary>
		public GadgeteerDSLDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class GadgeteerDSLDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new GadgeteerDSLDocView.
		/// </summary>
		...
		protected override bool LoadView()
		{
			...
			GadgeteerDSLDocDataBase docData = this.DocData as GadgeteerDSLDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for GadgeteerDSLDocViewBase should be an GadgeteerDSLDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::Microsoft.Gadgeteer.Designer.GadgeteerDSLDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::Microsoft.Gadgeteer.Designer.GadgeteerDSLDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Microsoft.Gadgeteer.Designer.GadgeteerDSLToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Microsoft.Gadgeteer.Designer.GadgeteerDSLToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.GadgeteerDSLDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Microsoft.Gadgeteer.Designer.GadgeteerDSLHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Microsoft.Gadgeteer.Designer.GadgeteerDSLHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Microsoft.Gadgeteer.Designer.GadgeteerDSLHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
