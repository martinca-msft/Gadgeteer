...
namespace $ManufacturerShortName$.Gadgeteer
{
    ...
    public class $HardwareShortName$ : GT.Mainboard
    {
        ...
        public $HardwareShortName$()
        {
            ...
            socket.NativeI2CWriteRead = nativeI2C;
            socket.AnalogInput3 = new $HardwareShortName$_AIN((Cpu.Pin)12);
            socket.AnalogInput4 = new $HardwareShortName$_AIN((Cpu.Pin)13);
            socket.AnalogInput5 = new $HardwareShortName$_AIN((Cpu.Pin)14);
            socket.AnalogOutput = new $HardwareShortName$_AnalogOut((Cpu.Pin)14);
            socket.PWM7 = new $HardwareShortName$_PWM((Cpu.Pin)17);
            socket.PWM8 = new $HardwareShortName$_PWM((Cpu.Pin)18);
            socket.PWM9 = new $HardwareShortName$_PWM((Cpu.Pin)19);
            GT.Socket.SocketInterfaces.RegisterSocket(socket);
    ...
    internal class $HardwareShortName$_PWM : GT.Socket.SocketInterfaces.PWM
    {
        ...
        public $HardwareShortName$_PWM(Cpu.Pin pin)
        {
            this.pin = pin;
        }
    ...
    internal class $HardwareShortName$_AIN : GT.Socket.SocketInterfaces.AnalogInput
    {
        ...
        public $HardwareShortName$_AIN(Cpu.Pin pin)
        {
            this.pin = pin;
        }
