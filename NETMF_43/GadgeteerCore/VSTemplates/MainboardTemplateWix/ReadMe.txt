...
You also need one of:
 Visual Studio 2015/2013/2012 (any edition) and .NET Micro Framework v4.3
 Visual Studio Express 2013/2012 for Windows Desktop and .NET Micro Framework v4.3
...
This template supports NETMF 4.1, NETMF 4.2 and NETMF 4.3 - so mainboards can provide a driver for all versions of NETMF.
