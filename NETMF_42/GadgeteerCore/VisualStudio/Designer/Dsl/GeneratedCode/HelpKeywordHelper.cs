...
namespace Microsoft.Gadgeteer.Designer
{
	...
	/// </remarks>
	public partial class GadgeteerDSLHelpKeywordHelper : GadgeteerDSLHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new GadgeteerDSLHelpKeywordHelper.
		/// </summary>
		protected GadgeteerDSLHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the GadgeteerDSLHelpKeywordHelper.
		/// </summary>
		public static GadgeteerDSLHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class GadgeteerDSLHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new GadgeteerDSLHelpKeywordHelperBase.
		/// </summary>
		protected GadgeteerDSLHelpKeywordHelperBase()
			: base() { }
