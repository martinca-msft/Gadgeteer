...
namespace Microsoft.Gadgeteer.Designer
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.GadgeteerDSLEditorFactoryId)]
	internal partial class GadgeteerDSLEditorFactory : GadgeteerDSLEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new GadgeteerDSLEditorFactory.
		/// </summary>
		public GadgeteerDSLEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class GadgeteerDSLEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected GadgeteerDSLEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new GadgeteerDSLDocData(this.ServiceProvider, typeof(GadgeteerDSLEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new GadgeteerDSLDocView(docData, this.ServiceProvider);
		}
	}
}
