...
4)  Optionally, change Image.jpg to a good quality top-down image of the mainboard with the socket side facing up,
...
6)  Now open a new Gadgeteer App (for the right version(s) of NETMF) and your mainboard should appear in the designer.
