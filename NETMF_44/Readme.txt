...
- Microsoft .NET Micro Framework 4.4               http://netmf.github.io/ 
...
- in the AppTemplateCS/VB's AppTemplate.vstemplate, change the public key token of wizard extension if using Temporary.snk
- running wizards as standalone: make sure the product is not installed as GAC assemblies have priority
