...
namespace Microsoft.Gadgeteer.Designer
{
	...
	/// </remarks>
	public partial class GadgeteerDSLToolboxHelper : GadgeteerDSLToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new GadgeteerDSLToolboxHelper.
		/// </summary>
		public GadgeteerDSLToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class GadgeteerDSLToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify GadgeteerDSL toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "GadgeteerDSL.1.0";
		/// <summary>
		/// Toolbox item filter string used to identify SocketConnectionTool connector tool.
		/// </summary>
		public const string SocketConnectionToolFilterString = "SocketConnectionTool.1.0";
		...
		/// <summary>
		/// Constructs a new GadgeteerDSLToolboxHelperBase.
		/// </summary>
		protected GadgeteerDSLToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::Microsoft.Gadgeteer.Designer.GadgeteerDSLDomainModel.SingletonResourceManager.GetString("GadgeteerToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::Microsoft.Gadgeteer.Designer.GadgeteerDSLDomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "Microsoft.Gadgeteer.Designer.SocketConnectionToolToolboxItem":

					// Add SocketConnectionTool connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"Microsoft.Gadgeteer.Designer.SocketConnectionToolToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						1, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("SocketConnectionToolToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("SocketConnectionToolToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.				
						"Microsoft.Gadgeteer.Designer.GadgeteerToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("GadgeteerToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"SocketConnectionTool", // F1 help keyword for the toolbox item.
						resourceManager.GetString("SocketConnectionToolToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						null, // Connector toolbox items do not have an underlying data object.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
							new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require), 
							new global::System.ComponentModel.ToolboxItemFilterAttribute(SocketConnectionToolFilterString)
						});
					break;
				case "Microsoft.Gadgeteer.Designer.CommentToolboxItem":
					// Add Comment shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"Microsoft.Gadgeteer.Designer.CommentToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						CreateElementToolPrototype(store, global::Microsoft.Gadgeteer.Designer.Comment.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::Microsoft.Gadgeteer.Designer.GadgeteerDSLDomainModel));
