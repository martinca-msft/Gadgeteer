...
namespace Microsoft.Gadgeteer.Designer
{
	...
	/// </summary>
	internal partial class GadgeteerDSLDocData : GadgeteerDSLDocDataBase
	{
		/// <summary>
		/// Constructs a new GadgeteerDSLDocData.
		/// </summary>
		public GadgeteerDSLDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a GadgeteerDSL document in memory.
	/// </summary>
	internal abstract partial class GadgeteerDSLDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new GadgeteerDSLDocDataBase.
		/// </summary>
		protected GadgeteerDSLDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::Microsoft.Gadgeteer.Designer.GadgeteerDSLDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::Microsoft.Gadgeteer.Designer.GadgeteerDSLDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::Microsoft.Gadgeteer.Designer.GadgeteerDSLDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::Microsoft.Gadgeteer.Designer.GadgeteerDSLDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::Microsoft.Gadgeteer.Designer.GadgeteerModel modelRoot = null;
			...
			global::Microsoft.Gadgeteer.Designer.GadgeteerDSLDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::Microsoft.Gadgeteer.Designer.GadgeteerDSLSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::Microsoft.Gadgeteer.Designer.GadgeteerDSLDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::Microsoft.Gadgeteer.Designer.GadgeteerDSLDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::Microsoft.Gadgeteer.Designer.GadgeteerModel modelRoot = (global::Microsoft.Gadgeteer.Designer.GadgeteerModel)this.RootElement;
			...
			{
				global::Microsoft.Gadgeteer.Designer.GadgeteerDSLDiagram diagram = diagrams[0] as global::Microsoft.Gadgeteer.Designer.GadgeteerDSLDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::Microsoft.Gadgeteer.Designer.GadgeteerDSLSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::Microsoft.Gadgeteer.Designer.GadgeteerDSLSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::Microsoft.Gadgeteer.Designer.GadgeteerDSLDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::Microsoft.Gadgeteer.Designer.GadgeteerDSLSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::Microsoft.Gadgeteer.Designer.GadgeteerModel modelRoot = this.RootElement as global::Microsoft.Gadgeteer.Designer.GadgeteerModel;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::Microsoft.Gadgeteer.Designer.GadgeteerDSLSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
