...
namespace Gadgeteer
{
    ...
    public class Program
    {
        ...
        /// <summary>
        /// Allows the user to override operation scheduling. Should be called from Program's static constructor to have any effect.
        /// </summary>
        /// <param name="dispatcher">the operation scheduler to use.</param>
        protected static void UseDispatcher(IDispatcher dispatcher)
        {
            if (_dispatcher != null && _dispatcher != dispatcher)
                throw new InvalidOperationException("Dispatcher has already been set.");

            _dispatcher = dispatcher;
        }

        internal static IDispatcher Dispatcher { get { if (_dispatcher == null) _dispatcher = new SingleFrameDispatcher(); return _dispatcher; } }
        ...
        public static void BeginInvoke(Delegate method, params object[] args)
        {
            ...
            {
                Program.Dispatcher.BeginInvoke(method, args);
            }
        }
        ...
        public static bool CheckAndInvoke(Delegate eventTriggered, Delegate onEvent, params object[] args)
        {
            ...
            if (Program.Dispatcher.CheckAccess()) return true;
