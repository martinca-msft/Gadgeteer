...
namespace Gadgeteer.Modules
{
    ...
    public abstract class DaisyLinkModule : Module
    {
        ...
        internal class DaisyLink : I2CBus
        {
            ...
            /// </summary>
            public byte NodeCount { get { return _nodeCount; } }

            private byte _reservedCount;
            /// <summary>
            /// Gets the count of reserved nodes.
            /// </summary>
            public byte ReservedCount { get { return _reservedCount; } }

            private byte _startAddress;
            /// <summary>
            /// Gets the starting address of this link.
            /// </summary>
            public byte StartAddress { get { return _startAddress; } }
            ...
            internal void Initialize()
            {
                lock (portLock)
                {
                    ...
                    _startAddress = (byte)(totalNodeCount + 1);
                    _nodeCount = modulesFound;
                    _reservedCount = 0;
