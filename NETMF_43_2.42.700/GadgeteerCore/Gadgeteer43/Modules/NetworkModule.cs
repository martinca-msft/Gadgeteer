        ...
        public abstract class NetworkModule : Module
        {
            ...
            public NetworkInterface NetworkSettings
            {
                get
                {
                    ...
                    {
                        if (netif.PhysicalAddress == null) continue;
                        if (netif.PhysicalAddress.Length != physicalAddress.Length) continue;
            ...
            protected NetworkModule()
            {
                ...
                IsNetworkUp = false;
                new Thread(new ThreadStart(DHCPThread)).Start();
            }
            ...
            /// </summary>
            protected ManualResetEvent _needDHCP = new ManualResetEvent(false);
